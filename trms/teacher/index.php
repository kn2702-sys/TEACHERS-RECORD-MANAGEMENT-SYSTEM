...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT ID FROM tblteacher WHERE Email=:username AND password=:password";
                ...
                <div class="login-form">
                    <form action="" method="post" name="login">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Email Address" required="true" name="username">
                        </div>
                        <div class="form-group">
