...
<html lang="en">
    <head>
        ...
        <title>Search Results - TRMS</title>
        <!-- Favicon-->
        ...
        <main class="flex-shrink-0">
            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-column flex-xl-row text-center text-xl-start">
                                ...
                                <div class="ms-xl-4">
                                    <div class="input-group mb-2">
                                        <input class="form-control" type="text" placeholder="Search Teacher by Name or Subject" aria-label="Search..." aria-describedby="button-newsletter" name="searchinput" required style="width:350px;" />
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <div class="text-center">
                                ...
                                <h2 class="fw-bolder">Search List Against <font color="red">"<?php echo htmlspecialchars($searchdata); ?>"</font></h2>
                                <hr color="red" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gx-5">
                        <?php
                        $sql = "SELECT * from tblteacher where (isPublic='1') and (Name like :search OR TeacherSub like :search2)";
